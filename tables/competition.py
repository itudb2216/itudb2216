class Competition:
	...
	def update(self, old_competition_id):
		...
		tupel = (self.competition_id, self.pretty_name, self.type_, self.sub_type, self.country_id, self.country_name, self.country_latitude, self.country_longitude, self.domestic_league_code, self.name, self.confederation, old_competition_id)
		return query, tupel
