class Club:
	def __init__(self, club_id, name, pretty_name, domestic_competition_id, total_market_value = None, squad_size, average_age = None, foreigners_number, foreigners_percentage = None, national_team_players, stadium_name, stadium_seats, net_transfer_record, coach_name, url):
    ...
    def update(self):
        ...
        tupel = (self.name, self.pretty_name, self.domestic_competition_id, self.total_market_value, self.squad_size, self.average_age, self.foreigners_number, slef.foreigners_percentage, self.national_team_players, self.stadium_name, self.stadium_seats, self.net_transfer_record, self.coach_name, self.url, self.club_id)
		return query, tupel
