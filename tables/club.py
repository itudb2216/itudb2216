class Club:
	def __init__(self, club_id, name, pretty_name, domestic_competition_id, total_market_value = None, squad_size = None, average_age = None, foreigners_number = None, foreigners_percentage = None, national_team_players = None, stadium_name = None, stadium_seats = None, net_transfer_record = None, coach_name = None):
	...
	def add(self):
		query = "INSERT INTO CLUBS (CLUB_ID, NAME, PRETTY_NAME, DOMESTIC_COMPETITION_ID, TOTAL_MARKET_VALUE, SQUAD_SIZE, AVERAGE_AGE, FOREIGNERS_NUMBER, FOREIGNERS_PERCENTAGE, NATIONAL_TEAM_PLAYERS, STADIUM_NAME, STADIUM_SEATS, NET_TRANSFER_RECORD, COACH_NAME) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
