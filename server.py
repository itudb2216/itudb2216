    ...
    if not os.path.exists('./transfermarkt.db'):
        ...
        con.execute(
            "CREATE TABLE CLUBS (\
                ...
                NAME TEXT NOT NULL,\
                PRETTY_NAME TEXT NOT NULL,\
                DOMESTIC_COMPETITION_ID TEXT NOT NULL,\
                ...
                COACH_NAME TEXT,\
                FOREIGN KEY (DOMESTIC_COMPETITION_ID) REFERENCES COMPETITIONS (COMPETITION_ID) ON UPDATE CASCADE ON DELETE CASCADE\
            )"
        )
        con.execute(
            "CREATE TABLE GAMES (\
        ...
        con.execute(
            "CREATE TABLE PLAYERS (\
                ...
                club_pretty_name TEXT NOT NULL,\
                ...
                market_value_in_gbp REAL,\
                highest_market_value_in_gbp REAL,\
        ...
        con.execute( 
            "CREATE TABLE APPEARANCES (\
                ...
                FOREIGN KEY(player_club_id) REFERENCES CLUBS(club_id) ON UPDATE CASCADE ON DELETE CASCADE,\
                FOREIGN KEY(competition_id) REFERENCES COMPETITIONS(competition_id) ON UPDATE CASCADE ON DELETE CASCADE\
            )"
        )
        con.execute(
            "CREATE TABLE PLAYERVALUATIONS (\
                player_valuation_id INTEGER PRIMARY KEY AUTOINCREMENT,\
                datetime TEXT NOT NULL,\
                dateweek TEXT NOT NULL,\
                player_id INTEGER NOT NULL,\
                current_club_id INTEGER NOT NULL,\
                market_value INTEGER NOT NULL,\
                player_club_domestic_competition_id TEXT NOT NULL,\
                FOREIGN KEY(player_id) REFERENCES PLAYERS(player_id) ON UPDATE CASCADE ON DELETE CASCADE,\
                FOREIGN KEY(current_club_id) REFERENCES CLUBS(club_id) ON UPDATE CASCADE ON DELETE CASCADE,\
                FOREIGN KEY(player_club_domestic_competition_id) REFERENCES COMPETITIONS(competition_id) ON UPDATE CASCADE ON DELETE CASCADE\
            )"
        )
