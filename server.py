...
def create_app():
    ...
    app.add_url_rule("/updatedL/<appearance_id>", view_func=views.update_appearance)
    ...
    #db.add(Competition("1", "comp-pretty", "type", "sub-type", 10, "turkey", 100, 100, "tr", "name", "confederation", "url "))
    #db.add(Competition("2", "comp-pretty", "type", "sub-type", 10, "turkey", 100, 100, "tr", "name", "confederation", "url "))
    #db.add(Competition("3", "comp-pretty", "type", "sub-type", 10, "turkey", 100, 100, "tr", "name", "confederation", "url "))
    #db.add(Competition("4", "comp-pretty", "type", "sub-type", 10, "turkey", 100, 100, "tr", "name", "confederation", "url "))


    """ db.add(Club(16, "FCB", "Barcelona", "4", 12.5, 22, 26.9, 5, 25.4, 4, "BARCA", 30000, "NONE AT ALL", "XAVI", "asdf.com"))
    db.add(Club(17, "FCB", "Barcelona", "2", 12.5, 22, 26.9, 5, 25.4, 4, "BARCA", 30000, "NONE AT ALL", "XAVI", "asdf.com"))
    db.add(Club(18, "FCB", "Barcelona", "2", 12.5, 22, 26.9, 5, 25.4, 4, "BARCA", 30000, "NONE AT ALL", "XAVI", "asdf.com"))
